...
public sealed class AnalyzeDataFlowTool : IToolHandler
{
    ...
    /// <inheritdoc />
    public string Description => "Analyze data flow for a region of C# code, showing variables read, written, captured, and flowing in/out. startColumn / endColumn (optional) trim the region (1-based; Roslyn Character = column - 1); omitted keeps today's whole-line span (start of startLine through end of endLine). Do not force column 1 when omitted.";
