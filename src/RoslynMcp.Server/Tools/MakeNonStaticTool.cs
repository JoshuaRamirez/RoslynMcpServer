...
public sealed class MakeNonStaticTool : IToolHandler
{
    ...
    public string Description =>
        "Make a selected static method an instance method when a valid instance receiver exists. Removes the static modifier and updates type-name call sites and method-group conversions to an instance receiver (or this in the same type). allFiles: true walks every C# file and makes every eligible ordinary static method an instance method (sourceFile optional when true; cannot be combined with startLine, startColumn, endLine, endColumn, or symbolName).";
