...
public sealed class GenerateConstructorOperation : RefactoringOperationBase<GenerateConstructorParams>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (replacing)
        {
            // Annotate before the rewrite. Removing a constructor from an
        ...
        // Add constructor to type. Strip the per-execution annotation
    ...
    /// coverage as <c>GenerateEqualsHashCodeOperation.SpanCoversColumn</c> /
    /// <c>GenerateOverridesOperation.SpanCoversColumn</c>). Prefer
    ...
    /// <see cref="RemoveExistingConstructorAcrossPartialsAsync"/>, recover
