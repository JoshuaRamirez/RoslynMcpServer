...
public sealed class SafeDeleteParams
{
    ...
    /// <summary>
    /// When true, process every safely-deletable declaration in every C# document
    ...
    /// <summary>
    /// Start line of the selected symbol (1-based). Single-site only.
    /// Required when <see cref="AllFiles"/> is false.
    /// </summary>
    public int? StartLine { get; init; }

    /// <summary>
    /// Start column of the selected symbol (1-based). Single-site only.
    /// Required when <see cref="AllFiles"/> is false.
    /// </summary>
    public int? StartColumn { get; init; }

    /// <summary>
    /// End line of the selected symbol (1-based). Single-site only.
    /// Required when <see cref="AllFiles"/> is false.
    /// </summary>
    public int? EndLine { get; init; }

    /// <summary>
    /// End column of the selected symbol (1-based). Single-site only.
    /// Required when <see cref="AllFiles"/> is false.
    /// </summary>
    public int? EndColumn { get; init; }

    /// <summary>
    /// Optional symbol name used to confirm the selection. Single-site only.
    /// </summary>
