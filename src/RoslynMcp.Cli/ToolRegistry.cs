...
public sealed class ToolRegistry
{
    ...
    public static ToolRegistry BuildDefault()
    {
        ...
        r.RegisterRefactoring<GenerateConstructorOperation, GenerateConstructorParams>(
            "generate-constructor", "Generate a constructor from fields/properties; includeProperties (default true) includes settable properties; false uses instance fields only unless members names a property");
