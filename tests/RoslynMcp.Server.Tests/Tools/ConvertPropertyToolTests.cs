...
/// <summary>
/// Unit tests for ConvertPropertyTool.
/// Tests tool definition and argument validation.
/// </summary>
public class ConvertPropertyToolTests
{
    private readonly ConvertPropertyTool _tool;
    ...
    {
        // Assert
        Assert.Equal("convert_property", _tool.Name);
    }
