...
/// <summary>
/// Unit tests for RenameFileToMatchTypeTool.
/// Tests tool definition and argument validation.
/// </summary>
public class RenameFileToMatchTypeToolTests
{
    private readonly RenameFileToMatchTypeTool _tool;

    public RenameFileToMatchTypeToolTests()
    {
        // Fails loudly if workspace creation is attempted; argument validation is exercised via ExecuteAsync error paths.
        _tool = new RenameFileToMatchTypeTool(new ThrowingWorkspaceProvider());
    }
    ...
    {
        Assert.Equal("rename_file_to_match_type", _tool.Name);
    }
    ...
    public void GetDefinition_HasRequiredFields()
    {
        ...
        // solutionPath is required; sourceFile is optional (allFiles mode)
