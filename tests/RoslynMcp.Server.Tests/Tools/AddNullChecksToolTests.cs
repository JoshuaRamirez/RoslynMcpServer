...
/// <summary>
/// Unit tests for AddNullChecksTool.
/// Tests tool definition and argument validation.
/// </summary>
public class AddNullChecksToolTests
{
    private readonly AddNullChecksTool _tool;
    ...
    {
        // Assert
        Assert.Equal("add_null_checks", _tool.Name);
    }
    ...
    public void GetDefinition_HasRequiredFields()
    {
        ...
        // solutionPath is required; sourceFile / methodName are optional (allFiles mode)
