...
/// <summary>
/// Unit tests for GenerateEqualsHashCodeTool.
/// Tests tool definition and argument validation.
/// </summary>
public class GenerateEqualsHashCodeToolTests
{
    private readonly GenerateEqualsHashCodeTool _tool;
    ...
    {
        // Assert
        Assert.Equal("generate_equals_hashcode", _tool.Name);
    }
