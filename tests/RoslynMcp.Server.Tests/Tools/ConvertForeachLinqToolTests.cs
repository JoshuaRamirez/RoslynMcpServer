...
/// <summary>
/// Unit tests for ConvertForeachLinqTool.
/// Tests tool definition and argument validation.
/// </summary>
public class ConvertForeachLinqToolTests
{
    private readonly ConvertForeachLinqTool _tool;
    ...
    {
        // Assert
        Assert.Equal("convert_foreach_linq", _tool.Name);
    }
