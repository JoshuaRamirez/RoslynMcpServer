...
/// <summary>
/// Unit tests for ConvertTupleToStructTool.
/// Tests tool definition and argument validation.
/// </summary>
public class ConvertTupleToStructToolTests
{
    private readonly ConvertTupleToStructTool _tool;

    public ConvertTupleToStructToolTests()
    {
        // Fails loudly if workspace creation is attempted; argument validation is exercised via ExecuteAsync error paths.
        _tool = new ConvertTupleToStructTool(new ThrowingWorkspaceProvider());
    }
    ...
    {
        Assert.Equal("convert_tuple_to_struct", _tool.Name);
    }
