...
/// <summary>
/// Unit tests for ConvertToInterpolatedStringTool.
/// Tests tool definition and argument validation.
/// </summary>
public class ConvertToInterpolatedStringToolTests
{
    private readonly ConvertToInterpolatedStringTool _tool;
    ...
    {
        // Assert
        Assert.Equal("convert_to_interpolated_string", _tool.Name);
    }
